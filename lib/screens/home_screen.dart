                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  const Text(
                                    'Mai Gawahi deta hun ke Allah(عزوجل) siwa koi ebadat ke laiq nahi. Woh eik(single) hai aur uska koi sharik nahi. Aur mai gawahi deta hun ke Muhammad(ﷺ) Allah(عزوجل) ke bande hai aur rasul hai.',
                                    style: TextStyle(
                                      color: Colors.white,
                                    ),
                                  ),
